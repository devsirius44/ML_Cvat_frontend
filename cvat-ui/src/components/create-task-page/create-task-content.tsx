...
class CreateTaskContent extends React.PureComponent<Props & RouteComponentProps, State> {
    ...
    private validateBlocks = (): Promise<void> => new Promise((resolve, reject) => {
    ...
    private handleSubmitAndOpen = (): void => {
        ...
        this.validateBlocks()
            ...
            .then((createdTask) => {
                ...
                history.push(`/projects/create/task-type/${id}`);
                console.log(id);
            })
            .catch(() => {});
        // history.push('/projects/create/task-type');
    };
    ...
    private renderFilesBlock(): JSX.Element {
        ...
        return (
            <div style={{ backgroundColor: '#212D52', padding: '12px', borderRadius: '3px' }}>
                <Col span={24}>
                    {/* <Text type='danger'>* </Text>
    ...
    public render(): JSX.Element {
        ...
        return (
            <Row style={{ display: 'flex', justifyContent: 'center' }}>
                <Card className='upload-data'>
                    <Text style={{ color: 'white', fontSize: '20px' }}>Unlabeled Data</Text>
                    {/* <Col span={24}>
