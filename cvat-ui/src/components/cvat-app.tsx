...
import SelectTaskType from 'components/create-project-page/select-task-type';
...
import CreateLabel from './create-project-page/create-label';
                ...
                return (
                    <GlobalErrorBoundary>
                        <ShortcutsContextProvider>
                            <Layout style={{ minHeight: 'initial' }}>
                                <Header />
                                <Layout.Content style={{ height: '100%', background: '#0C1543' }}>
                                    {/* <ShortcutsDialog /> */}
                                    <GlobalHotKeys keyMap={subKeyMap} handlers={handlers}>
                                        <Switch>
                                            ...
                                            <Route exact path='/projects/create/upload-data' component={CreateTaskPageContainer} />
                                            <Route exact path='/projects/create/create-label' component={CreateLabel} />
                                            <Route exact path='/projects/create/task-type/:id' component={SelectTaskType} />
