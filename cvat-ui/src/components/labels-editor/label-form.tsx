        ...
        return (
            <CVATTooltip title={tooltipTitle}>
                <Button
                    ...
                    style={{
                        width: '200px', height: '40px', border: 'none', backgroundColor: '#39B677', fontSize: '18px', borderRadius: '6px',
                    }}
                    type='primary'
                    htmlType='submit'
                >
        ...
        return (
            <CVATTooltip title='Do not save the label and return'>
                <Button
                    ...
                    danger
                    style={{
                        width: '200px', height: '40px', border: 'none', fontSize: '18px', borderRadius: '6px',
                    }}
                    onClick={(): void => {
                        onCancel();
                    }}
        ...
        return (
            <Form onFinish={this.handleSubmit} layout='vertical' ref={this.formRef}>
                <Row justify='start' align='top'>
                    <Col span={12}>{this.renderLabelNameInput()}</Col>
                    <Col span={4} offset={1}>{this.renderLabelTypeInput()}</Col>
                    <Col span={5} offset={1}>
