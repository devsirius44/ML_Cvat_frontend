                ...
                description={(
                    <div className='cvat-projects-project-item-description'>
                        <div>
                            {ownerName && (
                                <>
                                    <Text style={{ color: 'white' }} type='secondary'>{`Created ${ownerName ? `by ${ownerName}` : ''}`}</Text>
                                    <br/>
                                </>
                            )}
                            <Text style={{ color: 'white' }} type='secondary'>{`Last updated ${updated}`}</Text>
                        </div>
                        <div>
                            <Dropdown overlay={<ProjectActionsMenuComponent projectInstance={instance} />}>
                                <Button className='cvat-project-details-button' style={{ color: 'white' }} type='link' size='large' icon={<MoreOutlined />} />
                            </Dropdown>
                        </div>
                    </div>
                )}
