...
function SignInLayout(props: SignInLayoutComponentProps): JSX.Element {
    ...
    return (
        <Layout style={{ backgroundColor: '#0C1543' }}>
            <SVGSigningBackground className='cvat-signing-background' />
            <Header className='cvat-signing-header'>
                <Row justify='center' align='middle'>
                    <Col {...logoSizes}>
                        <Icon className='avawatz-logo-icon' style={{ scale: '70%' }} component={CVATLogo} />
                    </Col>
                </Row>
            </Header>
            <Layout className='cvat-signing-layout'>
                <Content>
                    <Row justify='center' align='middle'>
                        <Col {...titleSizes} className='cvat-signing-title' style={{ scale: '75%' }}>
                            <Toy />
                        </Col>
                        {children}
                    </Row>
