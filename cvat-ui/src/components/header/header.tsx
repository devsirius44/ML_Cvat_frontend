...
function HeaderContainer(props: Props): JSX.Element {
    ...
    return (
        <Layout.Header className='cvat-header' style={{ paddingTop: '2rem', paddingBottom: '2rem', backgroundColor: '#0C1543' }}>
            <div className='cvat-left-header'>
                <Icon className='cvat-logo-icon' style={{ scale: '40%' }} component={CVATLogo} />
                <Button
            ...
            <div className='cvat-right-header'>
                ...
                <Dropdown placement='bottomRight' overlay={userMenu} className='cvat-header-menu-user-dropdown'>
                    <span>
                        ...
                        <Row>
                            <Col span={24}>
                                <Text strong className='cvat-header-menu-user-dropdown-user' style={{ color: 'white' }}>
